    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Contáctenos</h6>
                <h1 class="mb-5">Póngase en contacto</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">Santa Cruz, Bolivia</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                        ...
                        <div class="ms-3">
                            <h5 class="text-primary">Célular</h5>
                            <p class="mb-0">+591 62124725</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">sinarviveros@gmail.com</p>
                        </div>
                    </div>
                </div>
